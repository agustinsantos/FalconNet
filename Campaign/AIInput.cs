...
namespace FalconNet.Campaign
{
	public class AIInput
	{
		...
		public static void ReadCampAIInputs (string name)
		{
			...
			tmpName = name + ".AII";
#if TODO		
	if (!F4FindFile(tmpName,fileName,256,ref off,ref len))
	   throw new ArgumentException("File Aii not found");
#endif		
			MultiplatformIni initFile = new MultiplatformIni (tmpName);
			/* ATM Inputs */
