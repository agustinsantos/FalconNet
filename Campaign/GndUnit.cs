...
namespace FalconNet.Campaign
{
    ...
    public class GroundUnitClass : UnitClass
    {
        ...
        public GroundUnitClass(ushort type)
        ...
        public int DetectVs(CampBaseClass e, ref float d, ref int combat, ref int spotted, ref int capture, ref int nomove, ref int estr)
        { throw new NotImplementedException(); }
        ...
        {
            return (Objective)VUSTATIC.vuDatabase.Find(pobj);
        }

        public override Objective GetUnitSecondaryObj()
        {
            return (Objective)VUSTATIC.vuDatabase.Find(sobj);
        }

        public override Objective GetUnitObjective()
        {
            return (Objective)VUSTATIC.vuDatabase.Find(aobj);
        }
