...
namespace FalconNet.Common
{
    ...
    {
        public static void fscanf(StreamReader f, string format, out int var)
        {
        ...
        public static void fscanf(StreamReader f, string format, out float var)
        {
            throw new NotImplementedException();
        }
        public static void fscanf(StreamReader f, string format, out double var)
        {
            throw new NotImplementedException();
        }
    }
    ...
    /// <author>
    /// End-User License
    /// Use of this article and any related source code or other files is governed by the terms and
    /// conditions of The Code Project Open License.
    ///   writed by Jonathan Wood
    /// </author>
