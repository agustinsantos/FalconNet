...
namespace FalconNet.FalcLib
{
	public class Mddriver
	{
		 ...
		 */
		public const int TEST_BLOCK_LEN = 1000;
		public const int TEST_BLOCK_COUNT = 1000;
		
		public static string[] commonFileList = {
		...
		public static string[] englishFiles = {
		...
		public static string[] germanFiles = {
		"$B\\FALCON4.ACD = 915068ffa6cf2e17ae294f5abceff370",
		"$B\\FALCON4.ct = d7a33b0de1edb00ab78e35ee03808ee6",
		...
		public static string[]  frenchFiles = {
		"$B\\FALCON4.ACD = 915068ffa6cf2e17ae294f5abceff370",
		"$B\\FALCON4.ct = d7a33b0de1edb00ab78e35ee03808ee6",
		...
		public static string[] spanishFiles = {
		"$B\\FALCON4.ACD = 915068ffa6cf2e17ae294f5abceff370",
		"$B\\FALCON4.ct = d7a33b0de1edb00ab78e35ee03808ee6",
		...
		public static string[]  italianFiles = {
		"$B\\FALCON4.ACD = 915068ffa6cf2e17ae294f5abceff370",
		"$B\\FALCON4.ct = d7a33b0de1edb00ab78e35ee03808ee6",
		...
		public static string[] brazilianFiles = {
		"$B\\FALCON4.ACD = 915068ffa6cf2e17ae294f5abceff370",
		"$B\\FALCON4.CT = d7a33b0de1edb00ab78e35ee03808ee6",
		...
		public static string[][] localizedFiles = {
			englishFiles,
			englishFiles,
			englishFiles,
			germanFiles,
		...
		public static string LocalizedInvalidDataStr = null;
		
		public static string[]  InvalidDataStr = {
		 ...
		 */
		public static int FileVerify ( )
		{
		char** objectFileList;
		int retval = 0;
		string outStr; //[_MAX_PATH];
		...
		#if KERNEL
		//TODO #define memset(x,y,z)	bzero(x,z);
		//TODO #define memcpy(x,y,z)	bcopy(y, x, z)
		#endif
		
		#if i386
		//TODO #define Encode memcpy
		//TODO #define Decode memcpy
		#else 
		...
		// TODO #define F(x, y, z) (((x) & (y)) | ((~x) & (z)))
		// TODO #define G(x, y, z) (((x) & (z)) | ((y) & (~z)))
		// TODO #define H(x, y, z) ((x) ^ (y) ^ (z))
		// TODO #define I(x, y, z) ((y) ^ ((x) | (~z)))
		
		/* ROTATE_LEFT rotates x left n bits. */
		// TODO #define ROTATE_LEFT(x, n) (((x) << (n)) | ((x) >> (32-(n))))
		
		/*
		 * FF, GG, HH, and II transformations for rounds 1, 2, 3, and 4.
		 * Rotation is separate from addition to prevent recomputation.
		 */
		// TODO #define FF(a, b, c, d, x, s, ac) { \
			(a) += F ((b), (c), (d)) + (x) + (u_int32_t)(ac); \
			(a) = ROTATE_LEFT ((a), (s)); \
			(a) += (b); \
			}
		// TODO #define GG(a, b, c, d, x, s, ac) { \
			(a) += G ((b), (c), (d)) + (x) + (u_int32_t)(ac); \
			(a) = ROTATE_LEFT ((a), (s)); \
			(a) += (b); \
			}
		// TODO #define HH(a, b, c, d, x, s, ac) { \
			(a) += H ((b), (c), (d)) + (x) + (u_int32_t)(ac); \
			(a) = ROTATE_LEFT ((a), (s)); \
			(a) += (b); \
			}
		// TODO #define II(a, b, c, d, x, s, ac) { \
