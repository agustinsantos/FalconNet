...
public class ConfigOption<T>
{
	...
	public bool CheckID(string str) { return str.Substring(3).ToLower().Equals(Name); }
};
...
//TODO #define PLockModeNormal 0
//TODO #define PLockModeNearLabelColor 1
//TODO #define PLockModeNoSnap 2
//TODO #define PLockModeBreakLock 4
//TODO #define PLockNoTrees 8
...
strcpy(g_strWorldName,"SP3WORLD");
	...
	while(fgets(strLine, sizeof(strLine) / sizeof(strLine[0]), file))
	{
		...
		public static void ReadFalcon4Config()
		{
			...
			using(StreamReader file = new StreamReader(strDir + Path.DirectorySeparatorChar + "F4os.cfg"))
			{
			...
			// DEMON 110106 Changed values for os.
			using(StreamReader file = new StreamReader(strDir + Path.DirectorySeparatorChar + "F4osServer.cfg"))
			{
				// ParseFalcon4Config(file);
				testRead(file);
			}
		...
		private static void testRead(StreamReader file)
		{
			string line;
