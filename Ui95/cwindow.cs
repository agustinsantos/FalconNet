...
namespace FalconNet.Ui95
{
    ...
    {
        public long ID_;
        public long StartX_, StartY_;
        public long ItemX_, ItemY_;
        //!	short GrabType_;
        public long GrabType_;
        public C_Window Window_;
        public C_Base Control_;
    }
    ...
    public struct TOOL_TIP
    {
        ...
        public long Time_;
        public string Tip_;
        public short MouseX_, MouseY_;
        public short HelpOn_;
        public long HelpFont_;
	...
	public:
        ...
        public void SetUpdateRect(long x1, long y1, long x2, long y2, UI95_BITTABLE flags, long client)
        {
            throw new NotImplementedException();
        }
        ...
        public void DrawCircle(SCREEN surface, COLORREF color, long x, long y, float radius, UI95_BITTABLE Flags, long Client, UI95_RECT clip)
        {
            throw new NotImplementedException();
        }

        public void DrawArc(SCREEN surface, COLORREF color, long x, long y, float radius, short section, UI95_BITTABLE Flags, long Client, UI95_RECT clip)
        {
            throw new NotImplementedException();
        }
