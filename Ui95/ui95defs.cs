...
// build to suit :) BITWISE set the high byte of the long
	public enum UI95_ENUM// DONT use the highest bit (0x80000000) because this is a signed value
	{
...
public enum CDRAW
	...
	[Flags]
	public enum WM_USER_ // WM_USER Messages for the UI
	{
		C_WM_DRAWWINDOW			= 0x0400 + 5000,
		C_WM_UPDATE,
		C_WM_COPYTOFRONT,
		C_WM_TIMER,
	};
